...
public class MangoDB {
	...
	public static String getDocumentWithQuery(String dbName, String collection,  String documentKey){
		return getDocumentWithQuery(dbName, collection, documentKey, null, true, null, null);
	}
