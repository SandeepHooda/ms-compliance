angular.module('starter').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('app/home/home.html',
    "<ion-view title=\"Compliance\" cache-view=\"false\" class=\"backhroundcolor\" ng-init=\"callCxf();\" ng-controller=\"CTRL_HOME as $ctrl\"><ion-header-bar class=\"bar-positive\"><h1 class=\"title\">Compliance</h1></ion-header-bar><ion-content class=\"padding\"><div><span class=\"userName blockDisplay\">{{cxfResult}}</span></div></ion-content></ion-view>"
  );
  ...
  $templateCache.put('app/login/login.html',
    "<ion-view title=\"Login\" class=\"white\" ng-controller=\"CTRL_Login as $ctrl\" cache-view=\"false\"><ion-header-bar class=\"bar-positive\"><h1 class=\"title\">Login</h1></ion-header-bar><ion-content class=\"padding\"><input type=\"text\" placeholder=\"Work Email address\" ng-model=\"$ctrl.emailAddress\" ng-keyup=\"checkEnter()\"> <button ng-click=\"createUser()\" id=\"signin\" name=\"signin\" class=\"loginBtn\">Login</button></ion-content></ion-view>"
  );
